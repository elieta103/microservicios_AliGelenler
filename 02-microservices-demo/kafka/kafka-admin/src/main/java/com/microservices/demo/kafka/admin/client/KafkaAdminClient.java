...
public class KafkaAdminClient {
    ...
    public void createTopics() {
        ...
        try {
            ...
            throw new KafkaClientException("Se alcanzó el máximo numero de intentos para crear el kafka topic(s)!", t);
        }
    ...
    private void checkMaxRetry(int retry, Integer maxRetry) {
        if (retry > maxRetry) {
            throw new KafkaClientException("Se alcanzó el nuemro maximo de intentos, para leer el topico de kafka!");
        }
    }
    ...
    private Collection<TopicListing> getTopics() {
        ...
        try {
            ...
            throw new KafkaClientException("Se alcanzó el nuemro maximo de intentos, para leer el topico de kafka!", t);
        }
        return topics;
    }
